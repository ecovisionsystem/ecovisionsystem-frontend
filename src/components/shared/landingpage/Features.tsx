    ...
    <section className="py-24 bg-surface" id="features">
      <div className="max-w-max-content mx-auto px-gutter container">
        <div className="text-center mb-16">
          <h2 className="font-heading-page text-heading-page text-primary mb-4">
        ...
        <div className="bento-grid">
          ...
          <div className="col-span-12 md:col-span-8 bg-surface-raised rounded-xl p-8 border border-border-strong shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-heading-section text-heading-section text-primary mb-3">
                Species-Level Segmentation
              </h3>
              <p className="font-body-primary text-body-primary text-on-surface-variant mb-6 max-w-md">
                Our ensemble models classify vegetation down to the species
                level with unprecedented accuracy, distinguishing subtle
                differences between Spartina and Puccinellia in dense coastal
                marshes.
              </p>
              <div className="flex flex-col gap-2 mt-4 max-w-sm">
                <div className="flex items-center justify-between text-sm p-2 bg-surface rounded border border-border">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-class-spartina rounded-sm"></div>
                    Spartina maritima
                  </div>
                ...
                <div className="flex items-center justify-between text-sm p-2 bg-surface rounded border border-border">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-class-puccinellia rounded-sm"></div>
          ...
          <div className="col-span-12 md:col-span-4 bg-surface-raised rounded-xl p-8 border border-border-strong shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow flex flex-col">
            <div className="w-12 h-12 bg-warning/10 text-warning rounded-lg flex items-center justify-center mb-6">
              <BarChart2 size={24} />
            </div>
            <h3 className="font-heading-section text-heading-section text-primary mb-3">
            ...
            <p className="font-body-primary text-body-primary text-on-surface-variant mb-6">
              Every prediction includes MAPIE (Model Agnostic Prediction
              Interval Estimator) confidence scores, providing researchers with
            ...
            <div className="mt-auto bg-surface p-4 rounded border border-border">
              ...
              <div className="w-full h-2 bg-surface-overlay rounded-full relative mb-1">
                <div className="absolute left-[20%] right-[30%] h-full bg-brand-accent/30 rounded-full"></div>
                <div className="absolute left-[45%] w-1 h-3 -mt-0.5 bg-primary rounded-full"></div>
              </div>
              <div className="flex justify-between text-data-mono text-[10px] text-muted">
          ...
          <div className="col-span-12 bg-surface-raised rounded-xl p-8 border border-border-strong shadow-sm flex flex-col md:flex-row items-center gap-8 group hover:shadow-md transition-shadow">
            <div className="flex-1">
              <div className="w-12 h-12 bg-info/10 text-info rounded-lg flex items-center justify-center mb-6">
                <Cloud size={24} />
              </div>
              <h3 className="font-heading-section text-heading-section text-primary mb-3">
            ...
            <div className="w-full md:w-1/3 bg-surface p-4 rounded border border-border font-data-mono text-data-mono text-sm">
              <div className="flex justify-between border-b border-border py-2">
                <span className="text-secondary">Image Size</span>
                <span className="text-primary">2.4 GB GeoTIFF</span>
              </div>
              <div className="flex justify-between border-b border-border py-2">
                <span className="text-secondary">Patches</span>
                <span className="text-primary">14,204</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-secondary">Inference Time</span>
                <span className="text-success font-bold">3m 42s</span>
              </div>
            </div>
          </div>
        </div>
